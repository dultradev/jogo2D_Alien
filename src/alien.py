...
class Alien(Sprite):
    ...
    def __init__(self, alien_invasion_screen: pygame.Surface, alien_invasion_settings: Settings) -> None:
        ...
        self.image = pygame.image.load("/Users/mec/Documents/Projetos/Jogo2D/Game2D_Alien/images/alien.bmp")
    ...
    def update(self) -> None:
        ...
        self.rect.x = int(self.x)  # Atualiza a posição do rect do alienígena com base na nova coordenada x
