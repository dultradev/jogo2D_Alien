class Settings:
    ...
    def __init__(self):
        ...
        self.ship_speed = 2.9  # Velocidade da nave

        # Configurações dos projéteis
        self.bullet_speed = 2.8  # Velocidade dos projéteis
        ...
        self.bullet_allowed = (
            3  # Número máximo de projéteis que podem existir na tela ao mesmo tempo
        )
